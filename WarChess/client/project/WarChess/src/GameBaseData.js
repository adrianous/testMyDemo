...
var MTBaseData = {
    ...
    //_magicAttack:MagicBaseData._magicAttack*0.3,//法术攻击力
    //_magicDefense:MagicBaseData._magicDefense*0.45,//法术防御力
    _magicAttack:0,//法术攻击力
...
var HunterBaseData = {
    ...
    _attack:MTBaseData._attack*0.95,//攻击
...
var RobberBaseData = {
    ...
    _attack:MTBaseData._attack*0.9,//攻击
    _damageFloat:0.15,//攻击浮动比率
    _attackDefense:MTBaseData._attackDefense*0.75,//物理防御力
    _magicAttack:0,//法术攻击力
    _magicDefense:MagicBaseData._magicDefense*0.35,//法术防御力
    _critical:0.08,//暴击率
    _dodge:0.02,//闪躲率
    _angryPower:0.05,//怒气值修订
...
var TreatBaseData = {
    ...
    _attack:MTBaseData._attack*0.35,//攻击
    _damageFloat:0.15,//攻击浮动比率
    _attackDefense:MTBaseData._attackDefense*0.50,//物理防御力
    _magicAttack:MagicBaseData._magicAttack*0.6,//法术攻击力
    _magicDefense:MagicBaseData._magicDefense*0.90,//法术防御力
    _critical:0.1,//暴击率
    _dodge:0.05,//闪躲率
    _angryPower:0.05,//怒气值修订
...
var SoldierBaseData = {
    ...
    _attack:MTBaseData._attack*0.65,//攻击
    _damageFloat:0.10,//攻击浮动比率
    _attackDefense:MTBaseData._attackDefense*0.35,//物理防御力
    _magicAttack:0,//法术攻击力
    _magicDefense:MagicBaseData._magicDefense*0.05,//法术防御力
    _critical:0.01,//暴击率
    _dodge:0.01,//闪躲率
    _angryPower:0.05,//怒气值修订
